 ...
 */
public class CriteriaForJPA implements Criteria {
    ...
    public Criteria EqualTo(String property, Object value) {
        criterionList.add(new EqualToCriterionForJPA(property, value));
        return getSelf() ;
    }
    ...
    public Criteria NotEqualTo(String property, Object value) {
        criterionList.add(new NotEqualToCriterionForJPA(property, value));
        return getSelf() ;
    }
    ...
    public Criteria IsNull(String property) {
        criterionList.add(new NullCriterionForJPA(property));
        return getSelf() ;
    }
    ...
    public Criteria IsNotNull(String property) {
        criterionList.add(new NotNullCriterionForJPA(property));
        return getSelf() ;
    }
    ...
    public Criteria GreaterThan(String property, Object value) {
        criterionList.add(new GreaterThanCriterionForJPA(property, value));
        return getSelf() ;
    }
    ...
    public Criteria GreaterThanOrEqualTo(String property, Object value) {
        criterionList.add(new GreaterThanOrEqualToCriterionForJPA(property, value));
        return getSelf() ;
    }
    ...
    public Criteria LessThan(String property, Object value) {
        criterionList.add(new LessThanCriterionForJPA(property, value));
        return getSelf() ;
    }
    ...
    public Criteria LessThanOrEqualTo(String property, Object value) {
        criterionList.add(new LessThanOrEqualToCriterionForJPA(property, value));
        return getSelf() ;
    }
    ...
    public Criteria Like(String property, String value) {
        criterionList.add(new LikeCriterionForJPA(property, value));
        return getSelf() ;
    }
    ...
    public Criteria NotLike(String property, String value) {
        criterionList.add(new NotLikeCriterionForJPA(property, value));
        return getSelf() ;
    }
    ...
    public Criteria In(String property, Collection<?> values) {
        criterionList.add(new InCriterionForJPA(property, values));
        return getSelf() ;
    }
    ...
    public Criteria NotIn(String property, Collection<?> values) {
        criterionList.add(new NotInCriterionForJPA(property, values));
        return getSelf() ;
    }
    ...
    public Criteria Between(String property, Object value1, Object value2) {
        criterionList.add(new BetweenCriterionForJPA(property, value1, value2));
        return getSelf() ;
    }
    ...
    public Criteria NotBetween(String property, Object value1, Object value2) {
        criterionList.add(new NotBetweenCriterionForJPA(property, value1, value2));
        return getSelf() ;
    }
