 ...
 */
public class InCriterionForMapper extends AbstractCriterion<Example.Criteria> {
    /**
     * 属性名称
     */
    ...
    public InCriterionForMapper() {}

    public InCriterionForMapper(String property, Collection<?> value) {
    ...
    public Object adapt(Example.Criteria object) {
        return object.andIn(property, value);
    }
