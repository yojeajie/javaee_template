...
public class ReflectionUtils {
	...
	public static Object invokeMethod(Object object, String methodName, Class<?>[] parameterTypes,
			Object[] parameters) throws InvocationTargetException, IllegalAccessException, NoSuchMethodException {
	...
	public static Field getDeclaredField(Object object, String fieldName) throws NoSuchFieldException {
        ...
        throw new NoSuchFieldException("No such accessible field: "
                + fieldName + "() on class: " + object.getClass().getName());
	}	
