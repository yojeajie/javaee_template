 ...
 */
public class NotInCriterionForJPA extends AbstractCriterion<List<Object>> {
    /**
     * 属性名称
     */
    ...
    public NotInCriterionForJPA() {}

    public NotInCriterionForJPA(String property, Collection<?> value) {
    ...
    public Object adapt(List<Object> object) {
        StringBuilder sqlBuilder = new StringBuilder().append(" obj.").append(property).append(" NOT IN (");
