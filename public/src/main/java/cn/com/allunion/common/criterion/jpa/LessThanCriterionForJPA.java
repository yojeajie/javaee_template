 ...
 */
public class LessThanCriterionForJPA extends AbstractOneValueCriterion<List<Object>> {
    public LessThanCriterionForJPA() {
    }

    public LessThanCriterionForJPA(String property, Object value) {
